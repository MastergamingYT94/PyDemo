...
from api.get.items import cartItem, checkProduct, productRating, user, orders, ordersShipping, ordersMaster, shippingDetails
...
urlpatterns = [
    ...
    path('orders/<int:UserId>', orders.get_orders),
